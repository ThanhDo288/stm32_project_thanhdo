...
// ADC _lab 8
	 // Bu?c 1: Kích ho?t clock cho GPIOA (noi ch?a chân A0)
  ...
  ST7735_WriteString(0, 2*10, " cao ngoc thanh do", Font_7x10, ST7735_GREEN, ST7735_BLACK);
	
		ST7735_OutUDec(0,0,5*10);
	//ST7735_SetCursor(0,3*10);
	//ST7735_SetCursor(0,3*10);
  // ST7735_OutUDec(TestData[i+1]);
	//	for (int i = 0; i < SIZE; i++) {
	//		IO_HeartBeat();
	//		ST7735_OutUDec(TestData[i],0,i*10);
	//		ST7735_OutFix(TestData[i],7*10,(i)*10);
	//	  IO_Touch();
//}

 
	//ST7735_WriteString(0, 2*10, " March  2023", Font_7x10, ST7735_BLUE, ST7735_BLACK);
  /*HAL_Delay(3000);
  ST7735_FillScreen(ST7735_BLACK);
